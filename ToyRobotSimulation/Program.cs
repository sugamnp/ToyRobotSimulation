...
namespace ToyRobotSimulation
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Type 'Place' followed by a whitespace and a coordinate eg:'0,0,NORTH' to place the robot.");
            Console.WriteLine("Use 'Move' to move the robot by one unit.");
            Console.WriteLine("Use 'Left', 'Right', to change the robot's direction.");
            Console.WriteLine("Use 'Report' to know the robot's location");
